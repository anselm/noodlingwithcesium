! function(e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var t;
        t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.registerAframeClickDragComponent = e()
    }
}(function() {
    return function e(t, n, o) {
        ...
        1: [function(e, t, n) {
            ...
            function u(e, t) {
                t.set(e.components.position.data.x, e.components.position.data.y, e.components.position.data.z), i(e, function(e) {
                    e.components && e.components.position && t.set(t.x + e.components.position.data.x, t.y + e.components.position.data.y, t.z + e.components.position.data.z)
                })
            }
            ...
            function s(e, t, n, o, r, i) {
                function u(i) {
                    ...
                    var a = T(e, o, {
                        ...
                        E = f.z,
                        z = void 0;
                    z = v.copy(s), g.set(n.x, n.y, n.z), z = v.multiply(d.getWorldQuaternion()), g.applyQuaternion(z), j || (z.multiply(l), y.setFromQuaternion(z, m)), w.x = e.Math.radToDeg(y.x), w.y = e.Math.radToDeg(y.y), w.z = e.Math.radToDeg(y.z);
                    var D = {
                        x: p - g.x,
                        y: h - g.y,
                        z: E - g.z
                    };
                    t.parentEl !== t.sceneEl && (g.set(D.x, D.y, D.z), t.parentEl.object3D.worldToLocal(g), D.x = g.x, D.y = g.y, D.z = g.z), t.emit(b, {
                        nextPosition: D,
                        nextRotation: w,
                        clientX: c,
                        clientY: u
                    }), t.setAttribute("position", D), t.setAttribute("rotation", w)
                }
                ...
                function f(e) {
                    var t = e.detail;
                    "position" !== t.name && "rotation" !== t.name || h(t.oldData, t.newData) || u(x)
                }
                ...
                return document.addEventListener("mousemove", u), document.addEventListener("touchmove", a), o.addEventListener("componentchanged", f),
                    function(e) {
                        document.removeEventListener("mousemove", u), document.removeEventListener("touchmove", a), o.removeEventListener("componentchanged", f)
                    }
            }
            ...
            var p = function() {
                    function e(e, t) {
                        var n = [],
                            ...
                            i = void 0;
                        try {
                            for (var c, u = e[Symbol.iterator](); !(o = (c = u.next()).done) && (n.push(c.value), !t || n.length !== t); o = !0);
                        } catch (e) {
                            r = !0, i = e
                        } finally {
                            try {
                ...
                h = o(function(e) {
                    ...
                    function o(e, o, a) {
                        ...
                        if (c(e)) return !!c(o) && (e = r.call(e), o = r.call(o), u(e, o, a));
                        if (n(e)) {
                            if (!n(o)) return !1;
                ...
                j = function() {
                    ...
                    return {
                        unproject: function(o, r, i) {
                            ...
                            return t = t || e(o), r.applyMatrix4(n.getInverse(c.projectionMatrix)), a(o, c, r)
                        }
                    }
                }(),
                z = j.unproject,
                ...
                M = function() {
                    ...
                    return {
                        selectItem: function(c, a, f, d, s) {
                            ...
                            var y = Array.from(f.sceneEl.querySelectorAll("[" + a + "]")).map(function(e) {
                                    return e.object3D
                                }),
                                h = !0,
                            ...
                            var x = g.point,
                                b = g.object;
                            i.setFromNormalAndCoplanarPoint(f.components.camera.camera.getWorldDirection().clone().negate(), x.clone().sub(n));
                            var w = i.constant,
                ...
                A = function() {
                    function e(e, t) {
                        function r() {
                            for (var e = performance.now(); g.length && e - g[0].time > E;) g.shift()
                        }
                        ...
                        function c(n) {
                            ...
                            d && ! function() {
                                ...
                                y = d, h = {
                                    ...
                                    clientX: r,
                                    clientY: c
                                }, d.addEventListener(b, i), o = function(e) {
                        ...
                        function l() {
                            v = m.camera.el, document.addEventListener("mousedown", c), document.addEventListener("mouseup", a), document.addEventListener("touchstart", f), document.addEventListener("touchend", d), n = function(e) {
                                document.removeEventListener("mousedown", c), document.removeEventListener("mouseup", a), document.removeEventListener("touchstart", f), document.removeEventListener("touchend", d)
                            }
                        }
                    ...
                    return {
                        ...
                        didUnmount: function(e) {
                            var n = r.indexOf(e);
                            o && o(), o = void 0, n !== -1 && (r.splice(n, 1), 0 === r.length && t())
                        }
                    }
                }(),
                W = A.didMount,
